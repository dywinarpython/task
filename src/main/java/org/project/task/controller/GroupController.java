...
public class GroupController {
    ...
    @PatchMapping
    public Mono<ResponseEntity<Map<String, List<String>>>> setGroup(@RequestBody @Valid Mono<SetGroupDto> setGroupDtoMono, @AuthenticationPrincipal Jwt jwt){
        return groupService.setTask(setGroupDtoMono, jwt).map(ResponseEntity::ok);
    }
